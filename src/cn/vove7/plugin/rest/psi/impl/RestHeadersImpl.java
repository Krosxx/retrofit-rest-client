...
public class RestHeadersImpl extends ASTWrapperPsiElement implements RestHeaders {

  public RestHeadersImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<RestEHeader> getEHeaderList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RestEHeader.class);
  }
